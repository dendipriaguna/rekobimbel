                    ...
                    <div>
                        <div class="mb-5 sm:mb-8">
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400">
                                Masukkan No. WhatsApp dan password untuk masuk
                            </p>
                        </div>
                        <div>
                                ...
                                <div class="space-y-5">
                                    ...
                                    <div>
                                        <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                                            No. WhatsApp<span class="text-error-500">*</span>
                                        </label>
                                        <input type="tel" id="phone" name="phone" value="{{ old('phone') }}" placeholder="6281234567890" autofocus
                ...
                <div class="z-1 flex items-center justify-center">
                    ...
                    <div class="flex max-w-xs flex-col items-center">
                        ...
                        <p class="text-center text-gray-400 dark:text-white/60">
                            Sistem Rekomendasi Penempatan Guru Berbasis Profile Matching
                        </p>
                    </div>
                </div>
            </div>
