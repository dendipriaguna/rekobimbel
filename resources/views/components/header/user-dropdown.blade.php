<div class="relative" x-data="{
    ...
    <button
        ...
        type="button"
    >
        <span class="flex items-center justify-center overflow-hidden rounded-full h-11 w-11 border border-gray-200 dark:border-gray-700">
            <img src="{{ Auth::user()->photoUrl() }}" alt="{{ Auth::user()->name }}" class="h-full w-full object-cover" />
        </span>
